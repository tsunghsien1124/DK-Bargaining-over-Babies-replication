/******************************************************************************
 * Table A.5: What covaries with men’s intention to have a baby?
 ******************************************************************************/
...
* regress male intention on different explanatory factors
display "MALE INTENTION WITHOUT KIDS"
quietly: regress mintent   married   age_f-female countryFE* if(numkids == 0) [aweight = aweight2], noconstant robust
eststo C1

display "MALE INTENTION WITHOUT KIDS"
quietly: regress mintent   part_pres age_f-female countryFE* if(numkids == 0) [aweight = aweight2], noconstant robust 
eststo C2

display "MALE INTENTION WITH KIDS"
quietly: regress mintent   married   age_f-firstmale countryFE* if(numkids == 1) [aweight = aweight2], noconstant robust
eststo C3

display "MALE INTENTION WITH KIDS"
quietly: regress mintent   part_pres age_f-firstmale countryFE* if(numkids == 1) [aweight = aweight2], noconstant robust 
eststo C4
...
esttab C1 C2 C3 C4 C5 C6 using "$texres/table_A5.tex", replace ///
