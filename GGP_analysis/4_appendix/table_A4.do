/******************************************************************************
 * Table A.4: What covaries with women’s intention to have a baby?
 ******************************************************************************/
...
* regress female intention on different explanatory factors
display "FEMALE INTENTION WITHOUT KIDS"
quietly: regress fintent   married   age_f-female countryFE* if(numkids == 0) [aweight = aweight2], noconstant robust
eststo C1

display "FEMALE INTENTION WITHOUT KIDS"
quietly: regress fintent   part_pres age_f-female countryFE* if(numkids == 0) [aweight = aweight2], noconstant robust 
eststo C2

display "FEMALE INTENTION WITH KIDS"
quietly: regress fintent   married   age_f-firstmale countryFE* if(numkids ==1) [aweight = aweight2], noconstant robust
eststo C3

display "FEMALE INTENTION WITH KIDS"
quietly: regress fintent   part_pres age_f-firstmale countryFE* if(numkids ==1) [aweight = aweight2], noconstant robust 
eststo C4
...
esttab C1 C2 C3 C4 C5 C6 using "$texres/table_A4.tex", replace ///
